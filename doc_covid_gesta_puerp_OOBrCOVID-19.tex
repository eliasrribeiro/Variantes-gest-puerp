...
\hypersetup{
  pdftitle={Análises do SIVEP-Gripe},
...
\NormalTok{dados5 }\OtherTok{\textless{}{-}}\NormalTok{ dados5 }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{gestante\_puerp =} \FunctionTok{case\_when}\NormalTok{(}
...
\FunctionTok{ctable}\NormalTok{(dados5}\SpecialCharTok{$}\NormalTok{variante,dados5}\SpecialCharTok{$}\NormalTok{gestante\_puerp)}
\end{Highlighting}
\end{Shaded}
